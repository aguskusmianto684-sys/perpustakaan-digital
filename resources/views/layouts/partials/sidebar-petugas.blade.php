    ...
    <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
      <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->segment(2) == 'dashboard' ? 'active' : '' }}" href="/petugas/dashboard">
        ...
        {{-- ANGGOTA --}}
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->segment(2) == 'anggota' ? 'active' : '' }}" href="/petugas/anggota">
        ...
        {{-- PEMINJAMAN --}}
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->segment(2) == 'peminjaman' ? 'active' : '' }}" href="/petugas/peminjaman">
                <i class="ti ti-book"></i>
